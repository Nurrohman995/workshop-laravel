...
<body class="signup-page">
    <div class="signup-box">
        <div class="logo">
            <a href="javascript:void(0);">Pelatihan<b> Laravel</b></a>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_up" action="{{ url('register_proses') }}" method="POST">
                    @csrf
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <select class="form-control" name="id_prodi" required>
                                ...
                                @foreach (\App\Models\ProdiModel::all() as $p)
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password">
                        </div>
                    </div>
